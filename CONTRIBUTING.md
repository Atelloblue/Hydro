...
This repository contains Hydro's shared Chromium patches, resources, and
...
- Prefer existing Chromium, Helium, or Hydro patterns over introducing new abstractions.
- Keep changes focused and minimal.
- Proofread surrounding code before submitting.
- When adding new Hydro-authored files to the Chromium tree, include the Hydro
  copyright header used in other patches.
- Refer to existing Hydro patches for guidance if necessary.
...
By contributing to Hydro, you agree that your changes will be licensed under
